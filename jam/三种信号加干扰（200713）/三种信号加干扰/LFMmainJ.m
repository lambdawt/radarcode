%主函数
function []=LFMmainJ(fz,B,B1,Gt,Gr,F,Pt,L,Te,tau,tr,f0,f1,fs,frame,num_jilei,num_tongdao,num_cankao,num_baohu,Pfa,R,v,rcsk,sigma0,temp1) 
% clear all;
%  close all;
% clc;
global c;
...
%动目标检测
[s_mtd]=mtd(pc_result,M1,num_jilei,num_tongdao);
