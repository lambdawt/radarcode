%简单脉冲主函数
function []=JDmainJ_saopin(fz,B,Gt,Gr,F,Pt,L,Pfa,R,v,rcsk,sigma0,Te,tau,tr,f0,f1,fs,frame,num_jilei,num_tongdao,num_cankao,num_baohu) 
% clear all;
% close all;
% clc;
global c;
...
%%%%干扰信号 D,R1,tr,c,Aj,N,frame,fs,f_doppler1,tm,f0,tau,congmubiao
 ...
 [sig_noise,t_noise] = jam_sweepfrequency( fs_saopin,Bj_saopin,fj_saopin,frame_saopin,Prj_saopin,Tr_saopin,T_fr,Time_begin_saopin,K_sweep_saopin );   %目标回波信号、假目标信号、噪声叠加在一起送入接收机
