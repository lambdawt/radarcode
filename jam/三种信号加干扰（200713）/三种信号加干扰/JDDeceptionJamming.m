function [s_ft,echo3]=JDDeceptionJamming(D,R1,tr,c,Aj,N,frame,fs,f_doppler1,tm,f0,tau,congmubiao,temp1)
...
if temp1 == 3 %联合
    ...
    echo3(i+1,:)=Aj*rectpuls(tm-delt1-tau/2,tau).*exp(1j*2*pi*f0*(tm-delt1));
    end
    for i=1:frame
