%主函数
function []=BKmainJ(fz,B,Gt,Gr,F,Pt,L,Pfa,R,v,rcsk,sigma0,Te,tau,tr,f0,f1,fs,frame,num_jilei,num_tongdao,num_cankao,num_baohu,model,number1,code,temp1) 
% clear all;
%  close all;
% clc;
global c;
...
[s_ft,echo3]=BKDeceptionJamming(D,y,R1,tr,ts,c,Aj,N,frame,fs,f_doppler1,tm,f0,tau,congmubiao,y1,temp1);    
%目标回波信号、假目标信号、噪声叠加在一起送入接收机
