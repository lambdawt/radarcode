%主函数
function []=BKmainJ_dopplerblink(fz,B,Gt,Gr,F,Pt,L,Pfa,R,v,rcsk,sigma0,Te,tau,tr,f0,f1,fs,frame,num_jilei,num_tongdao,num_cankao,num_baohu,model,number1,code) 
% clear all;
%  close all;
% clc;
global c;
