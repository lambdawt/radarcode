%简单脉冲主函数
function []=JDmainJ_passive(fz,B,Gt,Gr,F,Pt,L,Pfa,R,v,rcsk,sigma0,Te,tau,tr,f0,f1,fs,frame,num_jilei,num_tongdao,num_cankao,num_baohu) 
% clear all;
% close all;
% clc;
global c;
...
CurrentT=2.2;
[ sig_jam,t_jam ] = jam_passive( s_echo_2,fs_JD,f0_JD,CurrentT,TargetStatus,WindV,PassivePara );
