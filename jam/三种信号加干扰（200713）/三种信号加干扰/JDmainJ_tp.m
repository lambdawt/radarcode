%简单脉冲主函数
function []=JDmainJ_tp(fz,B,Gt,Gr,F,Pt,L,Pfa,R,v,rcsk,sigma0,Te,tau,tr,f0,f1,fs,frame,num_jilei,num_tongdao,num_cankao,num_baohu) 
% clear all;
% close all;
% clc;
global c;
...
[noise_tp] =zaoshengtiaopin(fs_tp,Kfm,Prj_tp,Pn,Bn,fj_tp,frame_tp,Tr_tp);%目标回波信号、假目标信号、噪声叠加在一起送入接收机
