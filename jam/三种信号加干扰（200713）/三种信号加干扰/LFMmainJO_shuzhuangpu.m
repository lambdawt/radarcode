%主函数
function []=LFMmainJO_shuzhuangpu(fz,B,B1,Gt,Gr,F,Pt,L,Te,tau,tr,f0,f1,fs,frame,num_jilei,num_tongdao,num_cankao,num_baohu,Pfa,R,v,rcsk,sigma0) 
% clear all;
%  close all;
% clc;
global c;
...
%%%%干扰信号
Pn=(Bj_shuzhuangpu/(2.5*Kfm))^2;Bn=Bj_shuzhuangpu/2;
