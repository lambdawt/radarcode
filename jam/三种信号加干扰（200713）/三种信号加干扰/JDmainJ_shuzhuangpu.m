%简单脉冲主函数
function []=JDmainJ_shuzhuangpu(fz,B,Gt,Gr,F,Pt,L,Pfa,R,v,rcsk,sigma0,Te,tau,tr,f0,f1,fs,frame,num_jilei,num_tongdao,num_cankao,num_baohu) 
% clear all;
% close all;
% clc;
global c;
...
%%%%干扰信号 D,R1,tr,c,Aj,N,frame,fs,f_doppler1,tm,f0,tau,congmubiao
 Kfm=4e6;
Pn=(Bj_shuzhuangpu/2/(2.5*Kfm))^2;Bn=Bj_shuzhuangpu/2;
