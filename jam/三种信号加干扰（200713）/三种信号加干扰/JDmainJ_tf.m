%简单脉冲主函数
function []=JDmainJ_tf(fz,B,Gt,Gr,F,Pt,L,Pfa,R,v,rcsk,sigma0,Te,tau,tr,f0,f1,fs,frame,num_jilei,num_tongdao,num_cankao,num_baohu) 
% clear all;
% close all;
% clc;
global c;
...
[noise_tf] =zaoshengtiaofu(fs_tf,Bj_tf,fj_tf,Prj_tf,Tr_tf,frame_tf);%目标回波信号、假目标信号、噪声叠加在一起送入接收机
