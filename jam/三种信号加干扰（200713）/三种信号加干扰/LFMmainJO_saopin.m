%主函数
function []=LFMmainJO_saopin(fz,B,B1,Gt,Gr,F,Pt,L,Te,tau,tr,f0,f1,fs,frame,num_jilei,num_tongdao,num_cankao,num_baohu,Pfa,R,v,rcsk,sigma0) 
% clear all;
%  close all;
% clc;
global c;
...
%%%%干扰信号
Pn=(Bj_saopin/(2.5*Kfm))^2;Bn=Bj_saopin/2;
[ sig_noise,t_noise ] = jam_sweepfrequency( fs_saopin,Bj_saopin,fj_saopin,frame_saopin,Prj_saopin,Tr_saopin,T_fr,Time_begin_saopin,K_sweep_saopin );
