function [s_ft,echo3]=LFMtuoyinganrao(R,frame,tf,Aj,tm,tau,f0,B1,N,f_doppler1,f_doppler,vf,lamta,k,ts,c,fs,temp1)
...
if temp1 == 3%联合
    for i=0:frame-1
        ...
        echo3(i +1,:)=Aj*rectpuls(tm-delt1-P-tau/2,tau).*exp(1j*2*pi*(((f0-B1/2)+k*(tm-delt1-P)/2).*(tm-delt1-P)));
    end
    for i=1:frame
