...
ydata=xdata.*sk_dat;
plot(handles.axes1,real(ydata)), title(handles.axes1,'K分布杂波时域波形，实部');
plot(handles.axes4,imag(ydata)),title(handles.axes4,'K分布杂波时域波形，虚部');
%%%%%%%%求概率密度函数的参数%%%%%%%%%%%%%%%%%%
num=100;
...
xlabel(handles.axes2,'幅度'),
ylabel(handles.axes2,'概率密度');
...
title(handles.axes3,'杂波频谱'),xlabel(handles.axes3,'频率/Hz'),
ylabel(handles.axes3,'功率谱密度');
%%%%%%%% 理想高斯曲线%%%%%%%%%%%%
